    ...
    handleChange = (e) => {
     ...
     handleRegister = () => {
        const { username, password, profile_picture } = this.state;
            axios.post("/api/register", { username, password, profile_picture })
            .then((res) => {
        ...
        return(
            ...
            <div className='auth_container'>
                ...
                <div className='auth_button_container'>
                    <button className='black_button' onClick={()=> {this.handleLogin()}}>Login</button>
                    <button className='black_button' onClick={()=> {this.handleRegister()}}>Register</button>
                    </div>
                </div>
            </div>
        )
